...
The keys `project.author` and `project.contrib` are used either in the singular to indicate a single person, or in the plural to indicate a list of people. Here is a fictitious use case.
