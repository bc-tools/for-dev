...
You can specify a language using the [ISO 639 standard][1], then, if necessary, add a country using the [ISO 3166 standard][2]: for example, you can type either `fr` if you do not wish to specify France, or `fr-BE` to indicate Belgian French.
...
[2]: https://en.wikipedia.org/wiki/ISO_3166
