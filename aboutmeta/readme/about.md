...
This project allows metadata to be defined via `about.yaml` files, making it easier for third-party programs to manage digital projects (code projects and document-type projects).
