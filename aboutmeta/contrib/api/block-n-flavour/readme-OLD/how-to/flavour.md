...
Here are the steps to follow.
  ...
  1. The flavor definition is an unordered `YAML` list of unique main block names. There are two kinds of block.
...
<!-- IT PROJECT - FLAVOR YAML CONFIG. AUTO - START -->
XXXX
<!-- IT PROJECT - FLAVOR YAML CONFIG. AUTO - END -->
